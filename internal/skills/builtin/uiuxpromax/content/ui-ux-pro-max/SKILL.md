...
| `astro` | Islands architecture, content sites, partial hydration |
| `vue` | Composition API, Pinia, Vue Router |
| `nuxtjs` | SSR/SSG, routing, composables, data fetching |
| `nuxt-ui` | Nuxt UI components, overlays, app-shell patterns |
