...
from design_system import generate_design_system, _slugify_path_component
...
if __name__ == "__main__":
    ...
    if args.design_system:
        ...
        if args.persist:
            print("\n" + "=" * 60)
            print("✅ Design system persisted to design-system/")
            print("   📄 design-system/MASTER.md (Global Source of Truth)")
            if args.page:
                page_filename = _slugify_path_component(args.page, default="page")
