...
// It inspects for key indicator files like go.mod, setup.py, or package.json
// to identify the primary language and frameworks in use.
...
// Returns true if the .knowledge directory exists and contains files.
